...
public class PhysEntityTrackData {
   ...
   private PhysEntityTrackData(
      ...
      VSAttachmentConstraint springConstraint,
      VSHingeOrientationConstraint axleConstraint,
      int springId,
      int axleId,
      double trackRPM,
      double springDist
   ...
   public final PhysEntityTrackData updateWith(UpdateData update) {
      return new PhysEntityTrackData(
         this.trackPos,
         this.wheelAxis,
         this.shiptraptionID,
         update.springConstant,
         update.damperConstant,
         this.springConstraint,
         this.axleConstraint,
         this.springId,
         this.axleId,
         update.trackRPM,
         this.previousSpringDist
      );
   }
   ...
   public static PhysEntityTrackData from(CreateData data) {
      return new PhysEntityTrackData(
         ...
         data.springConstant,
         data.damperConstant,
         (VSAttachmentConstraint)data.springConstraint.getVsConstraint(),
         (VSHingeOrientationConstraint)data.axleConstraint.getVsConstraint(),
         data.springConstraint.getConstraintId(),
         data.axleConstraint.getConstraintId(),
         data.trackRPM,
         0.0
      );
   }
   ...
   public static record CreateData(
      ...
      double springConstant,
      double damperConstant,
      VSConstraintAndId springConstraint,
      VSConstraintAndId axleConstraint,
      double trackRPM
   ) {
   }

   public static record UpdateData(double springConstant, double damperConstant, double trackRPM) {
   }
}
